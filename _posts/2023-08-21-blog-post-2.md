...
- Make sure **language** and **grammar** are correct, avoid colloquial language (use tools like [Grammarly](www.grammarly.com) for finding and fixing typos)
...
- **Your language matters**
  ...
  - Use tools like [Grammarly](www.grammarly.com) for finding and fixing **typos**
